...
// to generate unlimited unique buckets (e.g. never use req.uri directly,
...
import { HttpRequest, onClientRequest, RateLimit } from "@automattic/vip-edge-workers-sdk";
...
onClientRequest((req: HttpRequest): void => {
  if (!req.uri.startsWith("/limited/")) return;
